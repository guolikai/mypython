...
def Pager(page,pages_all_count):
    ...
    page_html = []  
    first_html = "<a href='/app01/index/%d'>首页 </a>" % (1) 
    page_html.append(first_html)
    if page <=1:
        prev_html = "<a href='#'>上一页 </a>"
    else:    
        prev_html = "<a href='/app01/index/%d'>上一页 </a>" % (page-1) 
    ...
    if page+1 > pages_all_count:
        ...
        next_html = "<a href='/app01/index/%d'>下一页 </a>" % (page+1) 
    page_html.append(next_html)
       
    end_html =  "<a href='/app01/index/%d'>尾页 </a>" % (pages_all_count) 
